...
// const img = require(`../TrainerAsset/${acc.username}.jpg`)
        ...
        return (
            ...
            <div style={{ perspective: 2000}}>
                ...
                className='w-[426px] min-h-[600px] rounded-[30px] border-[4px] border-white hover:border-cyan-600 transition-all duration-150 hover:scale-[125%] cursor-grab relative'
                >
